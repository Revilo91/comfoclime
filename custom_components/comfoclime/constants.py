...
class APIDefaults(BaseModel):
    ...
    WRITE_TIMEOUT: int = Field(default=30, description="Timeout for write operations (PUT) in seconds - longer for dashboard updates")
    CACHE_TTL: float = Field(default=30.0, description="Cache time-to-live in seconds for telemetry and property reads")
