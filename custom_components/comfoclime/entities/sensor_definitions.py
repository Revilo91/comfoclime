...
CONNECTED_DEVICE_PROPERTIES = {
    20: [
        PropertySensorDefinition(
            name="HP Min. Outdoor Temperature",
            translation_key="hp_min_outdoor_temp",
            unit="°C",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
        ...
        PropertySensorDefinition(
            ...
            translation_key="hp_min_supply_temp_cooling",
            unit="°C",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
        ...
        PropertySensorDefinition(
            ...
            translation_key="hp_max_supply_temp_heating",
            unit="°C",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
        ...
        PropertySensorDefinition(
            ...
            translation_key="hp_min_comfort_temp_cooling",
            unit="°C",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
        ...
        PropertySensorDefinition(
            ...
            translation_key="hp_hysteresis_heating",
            unit="°C",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
        ...
        PropertySensorDefinition(
            ...
            translation_key="hp_hysteresis_cooling",
            unit="°C",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            entity_category=EntityCategory.DIAGNOSTIC,
